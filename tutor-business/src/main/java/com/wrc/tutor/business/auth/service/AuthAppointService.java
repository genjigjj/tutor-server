...
import com.wrc.tutor.business.common.config.RabbitConfig;
...
import com.wrc.tutor.common.entity.request.CloseBizContent;
import com.wrc.tutor.common.entity.request.RefundBizContent;
import com.wrc.tutor.common.entity.response.CloseResponse;
...
import com.wrc.tutor.common.mapper.MessageMapper;
...
import com.wrc.tutor.pay.feign.service.FeignCashinService;
...
public class AuthAppointService extends ServiceImpl<AppointMapper, Appoint> {
    ...
    @Autowired
    FeignCashinService iFeignCashin;
...
//      创建支付宝支付订单
        com.wrc.tutor.common.entity.bo.PayBizContent payBizContent = new com.wrc.tutor.common.entity.bo.PayBizContent();
...
//    private LocalDateTime timeExpire;
    ...
    @Transactional
    public void payCloseProcess(org.springframework.amqp.core.Message message, Channel channel, PayBizContent payBizContent) throws IOException {
...
//                channel.basicNack(message.getMessageProperties().getDeliveryTag(), false,true);
    ...
    @Transactional
    public void paySuccessProcess(org.springframework.amqp.core.Message message, Channel channel, PayBizContent payBizContent){
