...
import com.wrc.tutor.system.back.entity.vo.NavigationVO;
import com.wrc.tutor.system.back.service.BackNavigationService;
...
@RestController
@RequestMapping("/system/back/navigations")
@Api("导航接口")
