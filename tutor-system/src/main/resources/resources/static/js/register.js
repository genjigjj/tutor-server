$(function(){
    ...
    function checkUsername(){
        ...
        if (username === '') {
            ...
            var status = true
             $.ajax({
                url: '/tutor/users/isExist/'+username,
                type: 'get',
                dataType: 'json',
                async: false,
        ...
        $.ajax({ //发送请求
            ...
            error:function(data){ //ajax错误
                ...
                if(data.code === '1'){//账户错误
                    ...
                    $('.code').find('img').attr('src','/tutor/code/imageCode?width=100&height=40&r='+Math.random());
                    return false;
                    ...
                    .find('img').attr('src','/tutor/code/imageCode?width=100&height=40&r='+Math.random());
                    return false;
...
//	图形验证码点击事件
    $('.code').find('img').click(function(event) {
        $(this).attr('src', '/tutor/code/imageCode?width=100&height=40&r='+Math.random());
    });
});
